...
function bones_scripts_and_styles() {
	...
	if (!is_admin()) {
		...
		wp_register_script( 'jquery', '//code.jquery.com/jquery-1.10.2.min.js', false, null, true );
...
// the side menu
function bones_side_nav() {
	// display the wp3 menu if available
	wp_nav_menu(array(
		'container' => false,                           // remove nav container
		'container_class' => 'side-nav',           // class of container (should you choose to use it)
		'menu' => __( 'The Main Menu', 'bonestheme' ),  // nav name
		...
		'link_after' => '',                             // after each link
		'depth' => 0,                                   // limit the depth of the nav
		'fallback_cb' => 'bones_side_nav_fallback'      // fallback function
	));
} /* end side main nav */
...
// this is the fallback for header menu
function bones_side_nav_fallback() {
	wp_page_menu( array(
		'container' => false,
		'show_home' => true,
		#'menu_class' => 'side-nav',      // adding custom nav class
